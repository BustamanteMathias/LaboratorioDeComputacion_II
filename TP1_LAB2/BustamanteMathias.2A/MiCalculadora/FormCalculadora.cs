...
namespace MiCalculadora
{
    public partial class FormCalculadora : Form
    {
        ...
        private void btnCerrar_Click(object sender, EventArgs e)                    //EVENTO CLICK BOTON CERRAR
        {
            this.Close();
        }

        private void btnLimpiar_Click(object sender, EventArgs e)                   //EVENTO CLICK BOTON LIMPIAR
        {
            this.Limpiar();
        }

        private void btnOperar_Click(object sender, EventArgs e)                    //EVENTO CLICK BOTON OPERAR
        {
